...
require (
	...
	github.com/go-kure/kure v0.2.0-beta.7
...
require (
	...
	github.com/fluxcd/image-automation-controller/api v1.2.2 // indirect
	...
	github.com/fluxcd/source-watcher/api/v2 v2.2.2 // indirect
