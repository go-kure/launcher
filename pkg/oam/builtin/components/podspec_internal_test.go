...
func TestParsePodSpec_Errors(t *testing.T) {
	cases := []struct {
		...
		{"dnsConfig unknown key", map[string]any{"dnsConfig": map[string]any{"servers": []any{}}}, false, "servers"},
		...
		{"hostNetwork not bool", map[string]any{"hostNetwork": "yes"}, false, "hostNetwork"},
		...
		{"podSecurityContext unknown key", map[string]any{"podSecurityContext": map[string]any{"privileged": true}}, false, "privileged"},
		...
		{"readinessGates unknown key", map[string]any{"readinessGates": []any{map[string]any{"type": "x"}}}, false, "type"},
		...
		{"schedulingGroup unknown key", map[string]any{"schedulingGroup": map[string]any{"name": "g"}}, false, "name"},
