...
// TestExposeRule_EvaluateProfile_GatewayValidation is the C5 friction-#2 regression
// test: ExposeRule is registered as a TraitLoweringRule, not a TraitHandler, so
