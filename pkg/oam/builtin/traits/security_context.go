...
// component config. This prevents the downstream runtime's securityContextMutator from overwriting
// them with restricted defaults — the mutator only fires when SecurityContext is nil.
//
// The psaLevel property relaxes namespace PSA admission labels and the downstream runtime's
...
// matching the declared psaLevel rather than the downstream-default restricted.
...
func (s *securityContextSpec) buildPodSecurityContext() *corev1.PodSecurityContext {
	...
	default: // PSABaseline or PSAPrivileged
		...
		// (RunAsNonRoot, SeccompProfile). The downstream runtime's mutator skips non-nil contexts.
...
func (s *securityContextSpec) buildContainerSecurityContext() *corev1.SecurityContext {
	...
	default: // PSABaseline or PSAPrivileged
		...
		// prevent the downstream runtime's securityContextMutator from overwriting with restricted defaults.
