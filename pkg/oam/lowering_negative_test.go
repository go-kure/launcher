...
// TestLower_NameCollision_NamesBothOrigins is the C4 negative-test proof: a
...
// TestLower_DepthLimit_PrintsFullChain is the C4 negative-test proof: exceeding
...
// TestLower_IllegalPositionEmission_Rejected is the C4 negative-test proof: a rule
